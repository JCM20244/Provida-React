...
export const AuthProvider = ({ children }) => {
    ...
    const login = async (username, password) => {
            await axios.post('https://app-htrec.vercel.app/api/auth/login', { username, password })
            .then((res) =>{
    ...
    const logout = async () => {
        try {
            await axios.post('https://app-htrec.vercel.app/api/auth/logout');
    ...
    const register = async (username, password) => {
        try {
            const response = await axios.post('https://app-htrec.vercel.app/api/auth/register', { username, password });
